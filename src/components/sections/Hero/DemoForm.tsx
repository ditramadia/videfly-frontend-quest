    ...
    <>
      ...
      {step === 1 && (
        <div className="flex flex-col @sm:flex-row gap-2 mb-12 @sm:mb-32 @lg:mb-56">
          ...
          <div
            className={`h-11 transition-150 ${selectedValue ? 'hover:scale-105 active:scale-95' : ''} `}
          >
            <Button
              text="Analisa"
              color="primary"
      ...
      {step === 2 && (
        <form
          ...
          className="flex flex-col items-center md:items-start gap-6 lg:gap-8"
        >
          ...
          <div>
            <div className="flex gap-3 items-start">
              ...
              <p>
                ...
                <Link href="/terms-and-conditions" className="text-primary-500">
                  {' '}
