  ...
  return (
    <div className='container-md'>
      <div className='flex flex-col items-center gap-8'>
        <Label text='Features' />
        <h2 className='font-nunito font-bold text-2xl md:text-3xl lg:text-4xl text-center leading-10 md:leading-12 lg:leading-14'>Bagaimana Videfly Membantu Bisnismu? <br /> <span className='bg-gradient-to-r from-[#7F52FF] to-[#FB8570] text-transparent bg-clip-text'>Lebih Efisien, Lebih Mudah, Hasil Maksimal!</span></h2>
      </div>
